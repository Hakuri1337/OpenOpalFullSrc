    ...
    public static synchronized RenderPipeline getGuiPipeline() {
        if (LIQUID_GLASS_GUI == null) {
            RenderPipeline.Builder b = RenderPipeline.builder()
                    .withLocation(Identifier.of("oraculus", "pipeline/liquid_glass_gui"))
                    .withVertexShader(Identifier.of("oraculus", "core/liquid_glass_fullscreen"))
                    .withFragmentShader(Identifier.of("oraculus", "program/liquid_glass_gui"))
