...
public final class NoXZVelocity extends VelocityMode {
    ...
    private void tickInstantCharge() {
        ...
        final TimerModule timerModule = OraculusClient.getInstance().getModuleRepository().getModule(TimerModule.class);
    ...
    private boolean shouldIgnore() {
        ...
        final StuckModule stuck = OraculusClient.getInstance().getModuleRepository().getModule(StuckModule.class);
