package wtf.oraculus.client.feature.module.impl.combat.antikb.utility;
...
public final class AmadeusMoveUtility {

    private AmadeusMoveUtility() {
    }
    ...
    public static float getDirectionDegrees(float yaw) {
        final TargetStrafeModule targetStrafeModule = OraculusClient.getInstance().getModuleRepository().getModule(TargetStrafeModule.class);
