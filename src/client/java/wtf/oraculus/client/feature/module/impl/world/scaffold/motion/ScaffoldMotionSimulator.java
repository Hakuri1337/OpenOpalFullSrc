package wtf.oraculus.client.feature.module.impl.world.scaffold.motion;
...
public final class ScaffoldMotionSimulator {
    private double x;
    private double y;
    private double z;
    ...
    public ScaffoldMotionSimulator(final ClientPlayerEntity player) {
