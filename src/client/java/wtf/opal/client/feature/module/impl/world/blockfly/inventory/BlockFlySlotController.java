package wtf.opal.client.feature.module.impl.world.blockfly.inventory;
...
public final class BlockFlySlotController {
    ...
    public int findPlaceableSlot() {
        ...
        for (int slot = 0; slot < 9; slot++) {
            if (BlockFlyBlockUtil.isPlaceable(mc.player.getInventory().getStack(slot))) {
                return slot;
            }
        }
        return -1;
    ...
    public int countAllBlocks() {
        ...
        for (int slot = 0; slot < 36; slot++) {
            ...
            if (BlockFlyBlockUtil.isPlaceable(stack)) {
