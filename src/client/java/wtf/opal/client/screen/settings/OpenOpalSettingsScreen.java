package wtf.opal.client.screen.settings;
...
public final class OpenOpalSettingsScreen extends Screen {
    ...
    public OpenOpalSettingsScreen(final Screen parent) {
        super(Text.literal("OpenOpal Settings"));
        this.parent = parent;
    }
    ...
    public void render(final DrawContext context, final int mouseX, final int mouseY, final float delta) {
        ...
        context.drawTextWithShadow(this.textRenderer,
                Text.literal("Managed translation layer, Via 1.8.x and temporary OpenOpal preset"),
